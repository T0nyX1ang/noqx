...
def solve(E: Encoding) -> List:
    ...
    for r, c in E.clues:
        ...
        if len(value) == 1:
            ...
            if (
                (direction == "l" and c == 0)
                or (direction == "r" and c == E.C - 1)
                or (direction == "u" and r == 0)
                or (direction == "d" and r == E.R - 1)
            ):
    ...
    for r in range(E.R):
        for c in range(E.C):
            ...
            if 0 < r:
                ...
                require(var_in(conn_patterns[r][c], TOP_IN + ["."]) | ~var_in(conn_patterns[r - 1][c], BOTTOM_OUT))
                ...
                require((upstream_turn_counts[r - 1][c] == upstream_contribution + num_turns_here) | ~flow_from_top)
                # clue connectivity
            ...
            if r < E.R - 1:
                ...
                # Basic rules (no dangling edges)
                require(var_in(conn_patterns[r][c], BOTTOM_IN + ["."]) | ~var_in(conn_patterns[r + 1][c], TOP_OUT))
                ...
                require((upstream_turn_counts[r + 1][c] == upstream_contribution + num_turns_here) | ~flow_from_bottom)
                # upstream counting
            ...
            if 0 < c:
                ...
                # Basic rules (no dangling edges)
                require(var_in(conn_patterns[r][c], LEFT_IN + ["."]) | ~var_in(conn_patterns[r][c - 1], RIGHT_OUT))
                ...
                require((upstream_turn_counts[r][c - 1] == upstream_contribution + num_turns_here) | ~flow_from_left)
                # clue connectivity
            ...
            if c < E.C - 1:
                ...
                # Basic rules (no dangling edges)
                require(var_in(conn_patterns[r][c], RIGHT_IN + ["."]) | ~var_in(conn_patterns[r][c + 1], LEFT_OUT))
                ...
                require((upstream_turn_counts[r][c + 1] == upstream_contribution + num_turns_here) | ~flow_from_right)
                # clue connectivity
    ...
    def format_function(r: int, c: int):
