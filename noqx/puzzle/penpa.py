    ...
    def _pack_line(self):
        ...
        for point in self.line:
            ...
            if self.puzzle_name == "hashi":
                self.solution["line"][f"{index_1},{index_2}"] = 3 if point.label.endswith("_1") else 30
