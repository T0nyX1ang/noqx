...
def solve(puzzle: Puzzle) -> List[Puzzle]:
    ...
    for i, (ar, _) in enumerate(areas.items()):
        ...
        solver.add_program_line(fill_num(_range=range(len(ar), len(ar) + 1), _type="area", _id=i, color="white"))
        solver.add_program_line(count(1, _type="area", _id=i, color="not white"))
